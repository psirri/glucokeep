...
# Form implementation generated from reading ui file 'glucokeep_eventcarbs_v5.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.spinbox_carbs = QtWidgets.QSpinBox(self.centralwidget)
        self.spinbox_carbs.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.spinbox_carbs.setMaximum(999)
        self.spinbox_carbs.setObjectName("spinbox_carbs")
        self.horizontalLayout.addWidget(self.spinbox_carbs)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.event_title.setText(_translate("MainWindow", "Carbs"))
        self.spin_label.setText(_translate("MainWindow", "Carbs"))
        self.spinbox_carbs.setSuffix(_translate("MainWindow", " g"))
        self.desc_one.setText(_translate("MainWindow", "You can enter up to 999 grams of carbs."))
        self.time_label.setText(_translate("MainWindow", "Time"))
        self.desc_two.setText(_translate("MainWindow", "Select the time when you ate your meal."))
