...
# Form implementation generated from reading ui file 'glucokeep_event_insulinlong_v5.ui'
#
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.event_title.setText(_translate("MainWindow", "Long-Acting Insulin"))
        self.spin_label.setText(_translate("MainWindow", "Amount"))
        self.spinbox_units.setSuffix(_translate("MainWindow", " U"))
        self.desc_one.setText(_translate("MainWindow", "Long-acting insulin is typically taken 1-2 times per day. Examples of long-acting insulin include Lantus, Levemir, NPH, and Toujeo.\n"
"\n"
"You can enter an amount up to 100.0 U."))
        self.time_label.setText(_translate("MainWindow", "Time"))
        self.desc_two.setText(_translate("MainWindow", "Select the time when you took your long-acting insulin dose."))
